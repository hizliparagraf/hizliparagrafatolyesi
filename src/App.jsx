...
const quizData = [
  ...
  // ... (Diğer quiz verileri buraya eklenecek)
];
...
const ReadingPlatform = () => {
    ...
    const loadUserStats = async () => {
      if (user) {
        ...
        try {
          ...
          // Bu satırın her zaman çalışması, sonsuz yüklenmeyi önler
  ...
  if (currentPage === 'test') return <ReadingTestPage />;
